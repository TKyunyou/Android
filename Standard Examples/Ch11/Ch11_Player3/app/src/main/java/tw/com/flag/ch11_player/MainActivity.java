...
public class MainActivity extends AppCompatActivity implements
    ...
    void prepareMusic() {
        ...
        btnPlay.setEnabled(false);   //使播放钮不能单击 (要等准备好才能单击)
        btnStop.setEnabled(false);   //使停止按钮不能单击
    ...
    public void onPrepared(MediaPlayer mp) {
        btnPlay.setEnabled(true);  //当准备好时, 只需让【播放】按钮可以被单击即可
    }
    ...
    public void onCompletion(MediaPlayer mp) {
        ...
        btnStop.setEnabled(false);  //让停止按钮不能被单击
    }
